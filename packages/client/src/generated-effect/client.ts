...
type Endpoint3_1Input = {
  ...
  readonly permissionLevel?: Endpoint3_1Request["payload"]["permissionLevel"]
}
...
type Endpoint3_2Request = Parameters<RawClient["server.session"]["session.update"]>[0]
type Endpoint3_2Input = {
  ...
  readonly permissionLevel?: Endpoint3_2Request["payload"]["permissionLevel"]
}
const Endpoint3_2 = (raw: RawClient["server.session"]) => (input: Endpoint3_2Input) =>
  raw["session.update"]({
    params: { sessionID: input["sessionID"] },
    payload: { title: input["title"], permissionLevel: input["permissionLevel"] },
  }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )
