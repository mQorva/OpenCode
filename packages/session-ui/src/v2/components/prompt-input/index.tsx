      ...
      >
          ...
          <div
            ...
            onKeyDown={(event) => {
              ...
              if (event.key === "Enter" && !event.shiftKey && !event.isComposing) {
                ...
                props.controller.submit(event.ctrlKey || event.metaKey)
              }
            }}
        ...
        <div class="flex h-11 items-center gap-3 px-2">
          ...
          >
            ...
            <Show when={props.slotAfterControls}>{props.slotAfterControls}</Show>
          </div>
...
export function PromptInputV2Popover(props: {
  ...
  return (
    <div
      class="absolute inset-x-0 -top-2 z-40 flex max-h-80 -translate-y-full flex-col overflow-auto rounded-xl bg-v2-background-bg-layer-01 p-2 shadow-[var(--v2-elevation-raised)] no-scrollbar"
