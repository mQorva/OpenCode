export const dict = {
  ...
  "desktop.menu.go": "Гузаштан",
  "desktop.menu.window": "Тиреза",
  "desktop.menu.help": "Кӯмак",
  "desktop.menu.checkForUpdates": "Санҷиши навсозиҳо...",
  "desktop.menu.settings": "Танзимотҳо",
  "desktop.menu.reloadWebview": "Аз нав боркунии намоиши веб",
  "desktop.menu.restart": "Аз нав оғоз кардан",
  "desktop.menu.exportLogs": "Содироти сабтҳо...",
  "desktop.menu.newSession": "Сеанси нав",
  "desktop.menu.newWindow": "Тирезаи нав",
  "desktop.menu.closeWindow": "Пӯшидани тиреза",
  "desktop.menu.addProject": "Илова кардани лоиҳа",
  "desktop.menu.undo": "Бекор кардан",
  "desktop.menu.redo": "Такрор кардан",
  "desktop.menu.cut": "Буридан",
  "desktop.menu.copy": "Нусхабардорӣ",
  "desktop.menu.paste": "Гузоштан",
  "desktop.menu.delete": "Нест кардан",
  "desktop.menu.selectAll": "Ҳамаро интихоб кардан",
  "desktop.menu.toggleSidebar": "Паҳлӯи паҳлӯро иваз кунед",
  "desktop.menu.toggleTerminal": "Терминалро иваз кунед",
  "desktop.menu.toggleFileTree": "Гузариш кардани дарахти файл",
  "desktop.menu.reload": "Аз нав боркунӣ",
  "desktop.menu.toggleDeveloperTools": "Асбобҳои таҳиягар",
  "desktop.menu.actualSize": "Андозаи воқеӣ",
  "desktop.menu.zoomIn": "Калон кардан",
  "desktop.menu.zoomOut": "Хурд кардан",
  "desktop.menu.toggleFullScreen": "Экрани пурра",
  "desktop.menu.back": "Ба қафо",
  ...
  "desktop.menu.minimize": "Печонидан",
  "desktop.menu.maximize": "Кушодан",
  "desktop.menu.documentation": "Ҳуҷҷатҳои OpenCode",
  "desktop.menu.supportForum": "Форуми дастгирӣ",
  "desktop.menu.shareFeedback": "Фиристодани фикру мулоҳиза",
  "desktop.menu.reportBug": "Гузориши хато",
  "desktop.menu.ariaLabel": "Менюи OpenCode",
