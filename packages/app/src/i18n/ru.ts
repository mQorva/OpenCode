export const dict = {
  ...
  "desktop.menu.selectAll": "Выделить всё",
  ...
  "desktop.menu.reload": "Обновить",
  "desktop.menu.toggleDeveloperTools": "Инструменты разработчика",
  ...
  "desktop.menu.shareFeedback": "Оставить отзыв",
