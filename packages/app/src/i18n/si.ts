export const dict: Record<string, string> = {
  ...
  "desktop.menu.edit": "සංස්කරණය",
  "desktop.menu.view": "දසුන",
  "desktop.menu.go": "යන්න",
  "desktop.menu.window": "කවුළුව",
  "desktop.menu.help": "උදව්",
  "desktop.menu.checkForUpdates": "යාවත්කාලීන පරීක්ෂා කරන්න...",
  "desktop.menu.settings": "සැකසීම්",
  "desktop.menu.reloadWebview": "වෙබ් දසුන නැවත පූරණය කරන්න",
  "desktop.menu.restart": "නැවත ආරම්භ කරන්න",
  ...
  "desktop.menu.addProject": "ව්‍යාපෘතියක් එක් කරන්න",
  "desktop.menu.undo": "පසුගමන",
  "desktop.menu.redo": "නැවත කරන්න",
  "desktop.menu.cut": "කපන්න",
  ...
  "desktop.menu.toggleDeveloperTools": "සංවර්ධක මෙවලම්",
  "desktop.menu.actualSize": "සැබෑ ප්‍රමාණය",
  "desktop.menu.zoomIn": "විශාලනය",
  "desktop.menu.zoomOut": "කුඩාලනය",
  "desktop.menu.toggleFullScreen": "පූර්ණ තිරය",
  ...
  "desktop.menu.minimize": "කුඩා කරන්න",
  "desktop.menu.maximize": "විශාල කරන්න",
  "desktop.menu.documentation": "OpenCode ලේඛන",
  "desktop.menu.supportForum": "සහාය සංසදය",
  "desktop.menu.shareFeedback": "ප්‍රතිපෝෂණ එවන්න",
