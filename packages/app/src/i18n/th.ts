export const dict = {
  ...
  "desktop.menu.reloadWebview": "โหลดมุมมองเว็บใหม่",
  ...
  "desktop.menu.addProject": "เพิ่มโปรเจกต์",
  ...
  "desktop.menu.shareFeedback": "ส่งความคิดเห็น",
