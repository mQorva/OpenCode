export const dict = {
  ...
  "desktop.menu.toggleDeveloperTools": "개발자 도구",
  "desktop.menu.actualSize": "실제 크기",
  "desktop.menu.zoomIn": "확대",
  "desktop.menu.zoomOut": "축소",
  "desktop.menu.toggleFullScreen": "전체 화면",
