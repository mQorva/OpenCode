export const dict = {
  ...
  "desktop.menu.file": "ਫ਼ਾਈਲ",
  "desktop.menu.edit": "ਸੋਧੋ",
  "desktop.menu.view": "ਵੇਖੋ",
  "desktop.menu.go": "ਜਾਓ",
  "desktop.menu.window": "ਵਿੰਡੋ",
  "desktop.menu.help": "مدد",
  "desktop.menu.checkForUpdates": "ਅੱਪਡੇਟ ਵੇਖੋ...",
  "desktop.menu.settings": "ترتیبات",
  "desktop.menu.reloadWebview": "ਵੈੱਬ ਦ੍ਰਿਸ਼ ਮੁੜ ਲੋਡ ਕਰੋ",
  "desktop.menu.restart": "ਮੁੜ ਚਾਲੂ ਕਰੋ",
  "desktop.menu.exportLogs": "ਲਾਗ ਨਿਰਯਾਤ ਕਰੋ...",
  "desktop.menu.newSession": "نواں سیشن",
  "desktop.menu.newWindow": "ਨਵੀਂ ਵਿੰਡੋ",
  "desktop.menu.closeWindow": "ਵਿੰਡੋ ਬੰਦ ਕਰੋ",
  "desktop.menu.addProject": "ਪ੍ਰੋਜੈਕਟ ਸ਼ਾਮਲ ਕਰੋ",
  "desktop.menu.undo": "ਵਾਪਸ ਕਰੋ",
  "desktop.menu.redo": "ਮੁੜ ਕਰੋ",
  "desktop.menu.cut": "ਕੱਟੋ",
  "desktop.menu.copy": "ਕਾਪੀ ਕਰੋ",
  "desktop.menu.paste": "ਚੇਪੋ",
  "desktop.menu.delete": "ਮਿਟਾਓ",
  "desktop.menu.selectAll": "ਸਭ ਚੁਣੋ",
  "desktop.menu.toggleSidebar": "سائڈبار نوں ٹوگل کرو",
  "desktop.menu.toggleTerminal": "ٹرمینل نوں ٹوگل کرو",
  "desktop.menu.toggleFileTree": "فائل ٹری نوں ٹوگل کرو",
  "desktop.menu.reload": "ਮੁੜ ਲੋਡ ਕਰੋ",
  "desktop.menu.toggleDeveloperTools": "ਡਿਵੈਲਪਰ ਟੂਲ",
  "desktop.menu.actualSize": "ਅਸਲ ਆਕਾਰ",
  "desktop.menu.zoomIn": "ਜ਼ੂਮ ਇਨ",
  "desktop.menu.zoomOut": "ਜ਼ੂਮ ਆਊਟ",
  "desktop.menu.toggleFullScreen": "ਪੂਰੀ ਸਕਰੀਨ",
  "desktop.menu.back": "ਪਿੱਛੇ",
  "desktop.menu.forward": "ਅੱਗੇ",
  ...
  "desktop.menu.minimize": "ਛੋਟਾ ਕਰੋ",
  "desktop.menu.maximize": "ਵੱਡਾ ਕਰੋ",
  "desktop.menu.documentation": "OpenCode ਦਸਤਾਵੇਜ਼",
  "desktop.menu.supportForum": "ਸਹਾਇਤਾ ਫ਼ੋਰਮ",
  "desktop.menu.shareFeedback": "ਫ਼ੀਡਬੈਕ ਭੇਜੋ",
  "desktop.menu.reportBug": "ਬੱਗ ਦੀ ਰਿਪੋਰਟ ਕਰੋ",
  "desktop.menu.ariaLabel": "OpenCode ਮੀਨੂ",
