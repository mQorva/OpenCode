export const dict = {
  ...
  "desktop.menu.reloadWebview": "Επαναφόρτωση προβολής web",
  ...
  "desktop.menu.addProject": "Προσθήκη έργου",
  ...
  "desktop.menu.documentation": "Τεκμηρίωση OpenCode",
  "desktop.menu.supportForum": "Φόρουμ υποστήριξης",
  "desktop.menu.shareFeedback": "Αποστολή σχολίων",
  "desktop.menu.reportBug": "Αναφορά σφάλματος",
  "desktop.menu.ariaLabel": "Μενού OpenCode",
