export const dict: Record<string, string> = {
  ...
  "desktop.menu.view": "མཐོང་སྣང་།",
  "desktop.menu.go": "འགྱོ།",
  "desktop.menu.window": "སྒེའུ་ཁུང་།",
  "desktop.menu.help": "ཆ་རོགས་འབད་ནི",
  "desktop.menu.checkForUpdates": "དུས་མཐུན་བཟོ་ནི་ཞིབ་དཔྱད།...",
  "desktop.menu.settings": "སྒྲིག་སྟངས་ཚུ།",
  "desktop.menu.reloadWebview": "ཝེབ་མཐོང་སྣང་སླར་མངོན།",
  "desktop.menu.restart": "སླར་འགོ་བཙུགས།",
  "desktop.menu.exportLogs": "དྲན་དེབ་ཕྱིར་སྤྲོད།...",
  "desktop.menu.newSession": "ལཱ་ཡུན་གསརཔ།",
  "desktop.menu.newWindow": "སྒེའུ་ཁུང་གསརཔ།",
  "desktop.menu.closeWindow": "སྒེའུ་ཁུང་ཁ་བསྡམ།",
  "desktop.menu.addProject": "ལས་འགུལ་ཁ་སྐོང་།",
  "desktop.menu.undo": "རྒྱབ་ལོག",
  "desktop.menu.redo": "སླར་བསྐྱར།",
  "desktop.menu.cut": "བཏོག",
  "desktop.menu.copy": "འདྲ་བཤུས།",
  "desktop.menu.paste": "སྦྱར།",
  "desktop.menu.delete": "བཏོན་གཏང་།",
  "desktop.menu.selectAll": "ཆ་མཉམ་སེལ་འཐུ།",
  "desktop.menu.toggleSidebar": "ཟུར་ཁའི་ཕྲ་རིང་སོར་སྟོན་འབད།",
  "desktop.menu.toggleTerminal": "ཊར་མི་ནཱལ་སོར་བསྒྱུར་འབད།",
  "desktop.menu.toggleFileTree": "ཡིག་སྣོད་ཤིང་སོར་སྟོན་འབད།",
  "desktop.menu.reload": "སླར་མངོན།",
  "desktop.menu.toggleDeveloperTools": "གོང་འཕེལ་པའི་ལག་ཆས།",
  "desktop.menu.actualSize": "ངོ་མའི་ཚད།",
  "desktop.menu.zoomIn": "རྒྱས་བཏང་།",
  "desktop.menu.zoomOut": "བསྡུ་བཏང་།",
  "desktop.menu.toggleFullScreen": "གསལ་གཞི་གང་།",
  "desktop.menu.back": "རྒྱབ།",
  "desktop.menu.forward": "མདུན།",
  "desktop.menu.previousSession": "ཧེ་མའི་ལཱ་ཐེངས།",
  "desktop.menu.nextSession": "ལཱ་ཡུན་ཤུལ་མམ།",
  "desktop.menu.previousProject": "ལས་གཞི་སྔོན་མ།",
  "desktop.menu.nextProject": "ལས་གཞི་རྗེས་མ།",
  "desktop.menu.minimize": "ཆུང་བཟོ།",
  "desktop.menu.maximize": "སྦོམ་བཟོ།",
  "desktop.menu.documentation": "OpenCode ཡིག་ཆ།",
  "desktop.menu.supportForum": "རྒྱབ་སྐྱོར་གྲོས་སྡེ།",
  "desktop.menu.shareFeedback": "བསམ་འཆར་གཏང་།",
  "desktop.menu.reportBug": "སྐྱོན་སྙན་ཞུ།",
