export const dict = {
  ...
  "desktop.menu.edit": "တည်းဖြတ်",
  "desktop.menu.view": "မြင်ကွင်း",
  "desktop.menu.go": "သွားရန်",
  "desktop.menu.window": "ဝင်းဒိုး",
  "desktop.menu.help": "အကူအညီ",
  "desktop.menu.checkForUpdates": "အပ်ဒိတ်များ စစ်ဆေးရန်...",
  "desktop.menu.settings": "ဆက်တင်များ",
  "desktop.menu.reloadWebview": "ဝဘ်မြင်ကွင်း ပြန်ဖွင့်ရန်",
  "desktop.menu.restart": "ပြန်လည်စတင်ရန်",
  "desktop.menu.exportLogs": "မှတ်တမ်းများ ထုတ်ယူရန်...",
  "desktop.menu.newSession": "စက်ရှင်အသစ်",
  "desktop.menu.newWindow": "ဝင်းဒိုးအသစ်",
  "desktop.menu.closeWindow": "ဝင်းဒိုးပိတ်ရန်",
  "desktop.menu.addProject": "ပရောဂျက် ထည့်ရန်",
  "desktop.menu.undo": "နောက်ပြန်",
  "desktop.menu.redo": "ပြန်လုပ်",
  "desktop.menu.cut": "ဖြတ်ယူ",
  "desktop.menu.copy": "ကူးယူ",
  "desktop.menu.paste": "ကူးထည့်",
  "desktop.menu.delete": "ဖျက်",
  "desktop.menu.selectAll": "အားလုံးရွေး",
  "desktop.menu.toggleSidebar": "ဘေးဘားကို ပြောင်းရန်",
  "desktop.menu.toggleTerminal": "Terminal ကို ပြောင်းပါ",
  "desktop.menu.toggleFileTree": "ဖိုင်သစ်ပြောင်းရန်",
  "desktop.menu.reload": "ပြန်ဖွင့်",
  "desktop.menu.toggleDeveloperTools": "ဆော့ဖ်ဝဲရေးသားသူ ကိရိယာများ",
  "desktop.menu.actualSize": "အမှန်တကယ်အရွယ်အစား",
  "desktop.menu.zoomIn": "ချဲ့ကြည့်",
  "desktop.menu.zoomOut": "ချုံ့ကြည့်",
  "desktop.menu.toggleFullScreen": "မျက်နှာပြင်အပြည့်",
  "desktop.menu.back": "နောက်သို့",
  "desktop.menu.forward": "ရှေ့သို့",
  "desktop.menu.previousSession": "ယခင်စက်ရှင်",
  "desktop.menu.nextSession": "နောက်ဆက်ရှင်",
  "desktop.menu.previousProject": "ယခင်ပရောဂျက်",
  "desktop.menu.nextProject": "နောက်ပရောဂျက်",
  "desktop.menu.minimize": "ချုံ့ရန်",
  "desktop.menu.maximize": "ချဲ့ရန်",
  "desktop.menu.documentation": "OpenCode စာရွက်စာတမ်း",
  "desktop.menu.supportForum": "ပံ့ပိုးမှုဖိုရမ်",
  "desktop.menu.shareFeedback": "တုံ့ပြန်ချက် ပို့ရန်",
  "desktop.menu.reportBug": "ချွတ်ယွင်းချက် အစီရင်ခံရန်",
