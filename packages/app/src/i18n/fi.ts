export const dict = {
  ...
  "desktop.menu.addProject": "Lisää projekti",
  ...
  "desktop.menu.shareFeedback": "Lähetä palautetta",
  "desktop.menu.reportBug": "Ilmoita virheestä",
