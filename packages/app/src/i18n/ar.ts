export const dict = {
  ...
  "desktop.menu.checkForUpdates": "التحقق من التحديثات...",
  ...
  "desktop.menu.addProject": "إضافة مشروع",
  ...
  "desktop.menu.toggleSidebar": "تبديل الشريط الجانبي",
  "desktop.menu.toggleTerminal": "تبديل المحطة الطرفية",
  "desktop.menu.toggleFileTree": "تبديل شجرة الملفات",
  "desktop.menu.reload": "إعادة التحميل",
  "desktop.menu.toggleDeveloperTools": "أدوات المطور",
  "desktop.menu.actualSize": "الحجم الفعلي",
  "desktop.menu.zoomIn": "تكبير",
  "desktop.menu.zoomOut": "تصغير",
  "desktop.menu.toggleFullScreen": "ملء الشاشة",
  ...
  "desktop.menu.shareFeedback": "إرسال ملاحظات",
  "desktop.menu.reportBug": "الإبلاغ عن خطأ",
