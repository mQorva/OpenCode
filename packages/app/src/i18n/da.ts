export const dict = {
  ...
  "desktop.menu.addProject": "Tilføj projekt",
  "desktop.menu.undo": "Fortryd",
  "desktop.menu.redo": "Annullér fortryd",
  "desktop.menu.cut": "Klip",
  "desktop.menu.copy": "Kopiér",
  "desktop.menu.paste": "Sæt ind",
  "desktop.menu.delete": "Slet",
  "desktop.menu.selectAll": "Vælg alle",
  "desktop.menu.toggleSidebar": "Skift sidebjælke",
  "desktop.menu.toggleTerminal": "Skift terminal",
  "desktop.menu.toggleFileTree": "Skift filtræ",
  "desktop.menu.reload": "Genindlæs",
  "desktop.menu.toggleDeveloperTools": "Udviklerværktøjer",
  "desktop.menu.actualSize": "Faktisk størrelse",
  "desktop.menu.zoomIn": "Zoom ind",
  "desktop.menu.zoomOut": "Zoom ud",
  "desktop.menu.toggleFullScreen": "Fuld skærm",
  ...
  "desktop.menu.shareFeedback": "Send feedback",
