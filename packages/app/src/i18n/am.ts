export const dict = {
  ...
  "desktop.menu.go": "ሂድ ወደ",
  "desktop.menu.window": "መስኮት",
  "desktop.menu.help": "እገዛ",
  "desktop.menu.checkForUpdates": "ዝማኔዎችን ፈትሽ...",
  "desktop.menu.settings": "ቅንጅቶች",
  "desktop.menu.reloadWebview": "የድር እይታን እንደገና ጫን",
  "desktop.menu.restart": "እንደገና አስጀምር",
  "desktop.menu.exportLogs": "መዝገቦችን ላክ...",
  "desktop.menu.newSession": "አዲስ ክፍለ ጊዜ",
  "desktop.menu.newWindow": "አዲስ መስኮት",
  "desktop.menu.closeWindow": "መስኮቱን ዝጋ",
  "desktop.menu.addProject": "ፕሮጀክት አክል",
  "desktop.menu.undo": "ቀልብስ",
  "desktop.menu.redo": "ድገም",
  "desktop.menu.cut": "ቁረጥ",
  "desktop.menu.copy": "ቅዳ",
  "desktop.menu.paste": "ለጥፍ",
  "desktop.menu.delete": "ሰርዝ",
  "desktop.menu.selectAll": "ሁሉንም ምረጥ",
  "desktop.menu.toggleSidebar": "የጎን አሞሌን ቀይር",
  "desktop.menu.toggleTerminal": "ተርሚናል ቀይር",
  "desktop.menu.toggleFileTree": "ፋይል ዛፍን ቀይር",
  "desktop.menu.reload": "እንደገና ጫን",
  "desktop.menu.toggleDeveloperTools": "የገንቢ መሳሪያዎች",
  "desktop.menu.actualSize": "ትክክለኛ መጠን",
  "desktop.menu.zoomIn": "አጉላ",
  "desktop.menu.zoomOut": "አሳንስ",
  "desktop.menu.toggleFullScreen": "ሙሉ ማያ",
  ...
  "desktop.menu.minimize": "መስኮት አሳንስ",
  "desktop.menu.maximize": "መስኮት አስፋ",
  "desktop.menu.documentation": "የOpenCode ሰነድ",
  "desktop.menu.supportForum": "የድጋፍ መድረክ",
  "desktop.menu.shareFeedback": "አስተያየት ላክ",
  "desktop.menu.reportBug": "ስህተት ሪፖርት አድርግ",
  "desktop.menu.ariaLabel": "የOpenCode ምናሌ",
