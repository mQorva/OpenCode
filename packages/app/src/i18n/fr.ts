export const dict = {
  ...
  "desktop.menu.addProject": "Ajouter un projet",
  ...
  "desktop.menu.toggleSidebar": "Basculer la barre latérale",
  "desktop.menu.toggleTerminal": "Basculer le terminal",
  "desktop.menu.toggleFileTree": "Basculer l'arborescence des fichiers",
  "desktop.menu.reload": "Actualiser",
  "desktop.menu.toggleDeveloperTools": "Outils de développement",
  ...
  "desktop.menu.documentation": "Documentation OpenCode",
  "desktop.menu.supportForum": "Forum d'assistance",
  "desktop.menu.shareFeedback": "Envoyer un commentaire",
  "desktop.menu.reportBug": "Signaler un bug",
