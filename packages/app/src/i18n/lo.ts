export const dict = {
  ...
  "desktop.menu.view": "ມຸມມອງ",
  "desktop.menu.go": "ໄປທີ່",
  "desktop.menu.window": "ໜ້າຕ່າງ",
  "desktop.menu.help": "ຊ່ວຍ",
  "desktop.menu.checkForUpdates": "ກວດຫາການອັບເດດ...",
  "desktop.menu.settings": "ການຕັ້ງຄ່າ",
  "desktop.menu.reloadWebview": "ໂຫຼດມຸມມອງເວັບຄືນໃໝ່",
  "desktop.menu.restart": "ເລີ່ມໃໝ່",
  "desktop.menu.exportLogs": "ສົ່ງອອກບັນທຶກ...",
  "desktop.menu.newSession": "ເຊດຊັນໃໝ່",
  "desktop.menu.newWindow": "ໜ້າຕ່າງໃໝ່",
  "desktop.menu.closeWindow": "ປິດໜ້າຕ່າງ",
  "desktop.menu.addProject": "ເພີ່ມໂຄງການ",
  "desktop.menu.undo": "ຍົກເລີກ",
  "desktop.menu.redo": "ເຮັດຄືນໃໝ່",
  ...
  "desktop.menu.toggleTerminal": "ປິດ/ເປີດ terminal",
  "desktop.menu.toggleFileTree": "ສະຫຼັບຕົ້ນໄມ້ໄຟລ໌",
  "desktop.menu.reload": "ໂຫຼດຄືນໃໝ່",
  "desktop.menu.toggleDeveloperTools": "ເຄື່ອງມືນັກພັດທະນາ",
  "desktop.menu.actualSize": "ຂະໜາດຈິງ",
  "desktop.menu.zoomIn": "ຂະຫຍາຍ",
  "desktop.menu.zoomOut": "ຫຍໍ້",
  "desktop.menu.toggleFullScreen": "ເຕັມຈໍ",
  "desktop.menu.back": "ກັບຄືນ",
  "desktop.menu.forward": "ໄປໜ້າ",
  "desktop.menu.previousSession": "ເຊດຊັນທີ່ຜ່ານມາ",
  "desktop.menu.nextSession": "ເຊດຊັນຕໍ່ໄປ",
  "desktop.menu.previousProject": "ໂຄງການທີ່ຜ່ານມາ",
  "desktop.menu.nextProject": "ໂຄງການຕໍ່ໄປ",
  "desktop.menu.minimize": "ຫຍໍ້ໜ້າຕ່າງ",
  "desktop.menu.maximize": "ຂະຫຍາຍໜ້າຕ່າງ",
  "desktop.menu.documentation": "ເອກະສານ OpenCode",
  "desktop.menu.supportForum": "ເວທີສະໜັບສະໜູນ",
  "desktop.menu.shareFeedback": "ສົ່ງຄຳຕິຊົມ",
