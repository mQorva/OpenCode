export const dict = {
  ...
  "desktop.menu.view": "Տեսք",
  "desktop.menu.go": "Անցնել",
  "desktop.menu.window": "Պատուհան",
  "desktop.menu.help": "Օգնություն",
  "desktop.menu.checkForUpdates": "Ստուգել թարմացումները...",
  "desktop.menu.settings": "Կարգավորումներ",
  "desktop.menu.reloadWebview": "Վերաբեռնել վեբ դիտումը",
  "desktop.menu.restart": "Վերագործարկել",
  "desktop.menu.exportLogs": "Արտահանել գրանցամատյանները...",
  "desktop.menu.newSession": "Նոր նիստ",
  "desktop.menu.newWindow": "Նոր պատուհան",
  "desktop.menu.closeWindow": "Փակել պատուհանը",
  "desktop.menu.addProject": "Ավելացնել նախագիծ",
  "desktop.menu.undo": "Հետարկել",
  "desktop.menu.redo": "Կրկնել",
  "desktop.menu.cut": "Կտրել",
  "desktop.menu.copy": "Պատճենել",
  "desktop.menu.paste": "Տեղադրել",
  ...
  "desktop.menu.toggleFileTree": "Փոխարկել ֆայլի ծառը",
  "desktop.menu.reload": "Վերաբեռնել",
  "desktop.menu.toggleDeveloperTools": "Մշակողի գործիքներ",
  "desktop.menu.actualSize": "Իրական չափը",
  "desktop.menu.zoomIn": "Խոշորացնել",
  "desktop.menu.zoomOut": "Փոքրացնել",
  "desktop.menu.toggleFullScreen": "Լիաէկրան",
  ...
  "desktop.menu.minimize": "Ծալել",
  "desktop.menu.maximize": "Ծավալել",
  "desktop.menu.documentation": "OpenCode-ի փաստաթղթեր",
  "desktop.menu.supportForum": "Աջակցության ֆորում",
  "desktop.menu.shareFeedback": "Ուղարկել կարծիք",
  "desktop.menu.reportBug": "Հաղորդել սխալի մասին",
  "desktop.menu.ariaLabel": "OpenCode-ի ընտրացանկ",
