export const dict = {
  ...
  "desktop.menu.file": "Fíla",
  "desktop.menu.edit": "Ritstjórn",
  "desktop.menu.view": "Vís",
  "desktop.menu.go": "Far til",
  "desktop.menu.window": "Vindeyga",
  "desktop.menu.help": "Hjálp",
  "desktop.menu.checkForUpdates": "Leita eftir dagføringum...",
  "desktop.menu.settings": "Innstillingar",
  "desktop.menu.reloadWebview": "Endurles vevsýnið",
  "desktop.menu.restart": "Byrja umaftur",
  "desktop.menu.exportLogs": "Flyt loggar út...",
  "desktop.menu.newSession": "Nýggj setan",
  "desktop.menu.newWindow": "Nýtt vindeyga",
  "desktop.menu.closeWindow": "Lat vindeygað aftur",
  "desktop.menu.addProject": "Legg verkætlan afturat",
  "desktop.menu.undo": "Ógilda",
  "desktop.menu.redo": "Ger umaftur",
  "desktop.menu.cut": "Klipp",
  "desktop.menu.copy": "Avrita",
  "desktop.menu.paste": "Set inn",
  ...
  "desktop.menu.reload": "Endurles",
  "desktop.menu.toggleDeveloperTools": "Menningarambød",
  "desktop.menu.actualSize": "Veruliga stødd",
  "desktop.menu.zoomIn": "Zooma inn",
  "desktop.menu.zoomOut": "Zooma út",
  "desktop.menu.toggleFullScreen": "Fullur skermur",
  "desktop.menu.back": "Aftur",
  "desktop.menu.forward": "Fram",
  ...
  "desktop.menu.minimize": "Minka",
  "desktop.menu.maximize": "Støkka",
  "desktop.menu.documentation": "OpenCode skjalfesting",
  "desktop.menu.supportForum": "Stuðulsforum",
  "desktop.menu.shareFeedback": "Send afturmelding",
  "desktop.menu.reportBug": "Meld frá einum feili",
