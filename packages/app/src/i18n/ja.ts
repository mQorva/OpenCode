export const dict = {
  ...
  "desktop.menu.reloadWebview": "Web ビューを再読み込み",
  "desktop.menu.restart": "再起動",
  "desktop.menu.exportLogs": "ログをエクスポート...",
  "desktop.menu.newSession": "新しいセッション",
  "desktop.menu.newWindow": "新規ウィンドウ",
  "desktop.menu.closeWindow": "ウィンドウを閉じる",
  "desktop.menu.addProject": "プロジェクトを追加",
  "desktop.menu.undo": "取り消す",
  "desktop.menu.redo": "やり直す",
  "desktop.menu.cut": "切り取り",
  "desktop.menu.copy": "コピー",
  "desktop.menu.paste": "貼り付け",
  "desktop.menu.delete": "削除",
  "desktop.menu.selectAll": "すべて選択",
  "desktop.menu.toggleSidebar": "サイドバーの切り替え",
  "desktop.menu.toggleTerminal": "ターミナルの切り替え",
  "desktop.menu.toggleFileTree": "ファイルツリーを切り替え",
  "desktop.menu.reload": "再読み込み",
  "desktop.menu.toggleDeveloperTools": "デベロッパーツール",
  "desktop.menu.actualSize": "実際のサイズ",
  "desktop.menu.zoomIn": "拡大",
  "desktop.menu.zoomOut": "縮小",
  "desktop.menu.toggleFullScreen": "フルスクリーン",
  ...
  "desktop.menu.documentation": "OpenCode ドキュメント",
