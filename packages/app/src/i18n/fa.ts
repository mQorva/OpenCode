export const dict = {
  ...
  "desktop.menu.go": "رفتن به",
  "desktop.menu.window": "پنجره",
  "desktop.menu.help": "کمک کنید",
  "desktop.menu.checkForUpdates": "بررسی به‌روزرسانی‌ها...",
  "desktop.menu.settings": "تنظیمات",
  "desktop.menu.reloadWebview": "بارگذاری مجدد نمای وب",
  "desktop.menu.restart": "راه‌اندازی مجدد",
  "desktop.menu.exportLogs": "خروجی گرفتن از گزارش‌ها...",
  "desktop.menu.newSession": "جلسه جدید",
  "desktop.menu.newWindow": "پنجره جدید",
  "desktop.menu.closeWindow": "بستن پنجره",
  "desktop.menu.addProject": "افزودن پروژه",
  "desktop.menu.undo": "واگرد",
  "desktop.menu.redo": "ازنو",
  "desktop.menu.cut": "برش",
  "desktop.menu.copy": "رونوشت",
  "desktop.menu.paste": "چسباندن",
  "desktop.menu.delete": "حذف",
  "desktop.menu.selectAll": "انتخاب همه",
  ...
  "desktop.menu.toggleDeveloperTools": "ابزارهای توسعه‌دهنده",
  "desktop.menu.actualSize": "اندازه واقعی",
  "desktop.menu.zoomIn": "بزرگ‌نمایی",
  "desktop.menu.zoomOut": "کوچک‌نمایی",
  "desktop.menu.toggleFullScreen": "تمام‌صفحه",
  "desktop.menu.back": "بازگشت",
  "desktop.menu.forward": "جلو",
  ...
  "desktop.menu.minimize": "کمینه کردن",
  "desktop.menu.maximize": "بیشینه کردن",
  "desktop.menu.documentation": "مستندات OpenCode",
  "desktop.menu.supportForum": "انجمن پشتیبانی",
  "desktop.menu.shareFeedback": "ارسال بازخورد",
  "desktop.menu.reportBug": "گزارش اشکال",
