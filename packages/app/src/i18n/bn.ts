export const dict: Record<string, string> = {
  ...
  "desktop.menu.edit": "সম্পাদনা",
  "desktop.menu.view": "দেখুন",
  "desktop.menu.go": "যান",
  "desktop.menu.window": "উইন্ডো",
  "desktop.menu.help": "সাহায্য",
  "desktop.menu.checkForUpdates": "আপডেট পরীক্ষা করুন...",
  "desktop.menu.settings": "সেটিংস",
  "desktop.menu.reloadWebview": "ওয়েব ভিউ পুনরায় লোড করুন",
  "desktop.menu.restart": "পুনরায় চালু করুন",
  ...
  "desktop.menu.addProject": "প্রকল্প যোগ করুন",
  "desktop.menu.undo": "পূর্বাবস্থায় ফেরান",
  "desktop.menu.redo": "পুনরায় করুন",
  "desktop.menu.cut": "কাটুন",
  "desktop.menu.copy": "অনুলিপি করুন",
  "desktop.menu.paste": "আটকান",
  "desktop.menu.delete": "মুছুন",
  ...
  "desktop.menu.toggleDeveloperTools": "ডেভেলপার টুল",
  "desktop.menu.actualSize": "প্রকৃত আকার",
  "desktop.menu.zoomIn": "জুম ইন",
  "desktop.menu.zoomOut": "জুম আউট",
  "desktop.menu.toggleFullScreen": "পূর্ণ স্ক্রিন",
  "desktop.menu.back": "পিছনে",
  "desktop.menu.forward": "সামনে",
  "desktop.menu.previousSession": "আগের সেশন",
  "desktop.menu.nextSession": "পরবর্তী সেশন",
  "desktop.menu.previousProject": "আগের প্রকল্প",
  "desktop.menu.nextProject": "পরবর্তী প্রকল্প",
  "desktop.menu.minimize": "ছোট করুন",
  "desktop.menu.maximize": "বড় করুন",
  "desktop.menu.documentation": "OpenCode ডকুমেন্টেশন",
  "desktop.menu.supportForum": "সহায়তা ফোরাম",
  "desktop.menu.shareFeedback": "মতামত পাঠান",
  "desktop.menu.reportBug": "বাগ রিপোর্ট করুন",
