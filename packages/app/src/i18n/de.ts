...
export const dict = {
  ...
  "session.permission.allowOnce": "einmalig",
  "session.permission.allowSession": "für diese Session",
  "session.permission.allowProject": "für dieses Projekt",
  ...
  "session.file.notFound": "Datei nicht gefunden",
  "session.file.notFound.description": "{{path}} existiert nicht in diesem Arbeitsbereich.",
  ...
  "session.followupDock.title": "Warteschlange",
  "session.followupDock.collapse": "Nachrichten in der Warteschlange einklappen",
  "session.followupDock.expand": "Nachrichten in der Warteschlange ausklappen",
  ...
  "session.delete.titleMultiple": "mehrere Sitzungen löschen",
  "session.delete.confirmMultiple": "Diese {{count}} Sitzungen dauerhaft löschen?",
  "session.delete.buttonMultiple": "{{count}} Sitzungen löschen",
