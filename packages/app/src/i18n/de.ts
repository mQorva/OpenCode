...
export const dict = {
  ...
  "home.tasks.title": "Aufgaben",
  "home.tasks.project": "Projekt",
  "home.tasks.viewSessions": "Sitzungen anzeigen",
  "home.tasks.create.title": "Aufgabe erstellen",
  "home.tasks.create.action": "Neue Aufgabe",
  "home.tasks.edit.title": "Aufgabe bearbeiten",
  "home.tasks.fields.title": "Titel",
  "home.tasks.fields.title.placeholder": "Was soll erledigt werden?",
  "home.tasks.fields.description": "Beschreibung",
  "home.tasks.fields.description.placeholder": "Zusätzlichen Kontext für diese Aufgabe hinzufügen",
  "home.tasks.active": "Aktuelle Aufgaben",
  "home.tasks.archived": "Archivierte Aufgaben",
  "home.tasks.showArchived": "Archivierte anzeigen",
  "home.tasks.hideArchived": "Archivierte ausblenden",
  "home.tasks.restore": "Wiederherstellen",
  "home.tasks.reopen": "Erneut öffnen",
  "home.tasks.workspace": "Arbeitsfläche",
  "home.tasks.workspaceUnavailable": "Für diese Aufgabe ist keine verknüpfte Sitzung verfügbar.",
  "home.tasks.startFailed": "Die Aufgaben-Arbeitsfläche konnte nicht gestartet werden",
  "home.tasks.empty": "Noch keine Aufgaben",
  "home.tasks.empty.description": "Erstellen Sie eine Aufgabe, um die Arbeit für dieses Projekt zu organisieren.",
  "home.tasks.error": "Aufgaben konnten nicht geladen werden",
  "home.tasks.retry": "Erneut versuchen",
  "home.tasks.status.ready": "bereit",
  "home.tasks.status.active": "aktiv",
  "home.tasks.status.waiting": "wartet",
  "home.tasks.status.review": "zur Prüfung",
  "home.tasks.status.completed": "abgeschlossen",
  "home.tasks.status.cancelled": "abgebrochen",
  "home.providerTip":
  ...
  "settings.openrouter.title": "OpenRouter-Konto",
  "settings.openrouter.manage": "Verwalten",
  "settings.openrouter.connect.title": "OpenRouter verbinden",
  "settings.openrouter.connect.description": "Melden Sie sich im Browser an oder hinterlegen Sie einen OpenRouter-API-Schlüssel.",
  "settings.openrouter.connected": "OpenRouter ist verbunden",
  "settings.openrouter.disconnected": "OpenRouter wurde getrennt",
  "settings.openrouter.verified": "Der OpenRouter-Zugang wurde geprüft",
  "settings.openrouter.modelsUpdated": "Die OpenRouter-Modelle wurden aktualisiert",
  "settings.openrouter.pkce.start": "Mit OpenRouter verbinden",
  "settings.openrouter.pkce.waiting": "Warten auf OpenRouter …",
  "settings.openrouter.pkce.failed": "Die OpenRouter-Anmeldung konnte nicht abgeschlossen werden.",
  "settings.openrouter.pkce.cancelled": "Die OpenRouter-Anmeldung wurde abgebrochen.",
  "settings.openrouter.pkce.expired": "Die OpenRouter-Anmeldung ist abgelaufen.",
  "settings.openrouter.key": "API-Schlüssel",
  "settings.openrouter.label": "Name (optional)",
  "settings.openrouter.key.connect": "API-Schlüssel verbinden",
  "settings.openrouter.key.replace": "API-Schlüssel ersetzen",
  "settings.openrouter.key.new": "Neuer API-Schlüssel",
  "settings.openrouter.account": "Konto",
  "settings.openrouter.status": "Status",
  "settings.openrouter.usage": "Nutzung",
  "settings.openrouter.models": "Verfügbare Modelle",
  "settings.openrouter.verify": "Zugang prüfen",
  "settings.openrouter.models.refresh": "Modelle aktualisieren",
  "settings.openrouter.models.select": "Modelle auswählen",
  "settings.openrouter.limitRemaining": "Verbleibendes Limit",
  "settings.openrouter.verifiedAt": "Zuletzt geprüft",
  "settings.openrouter.expiresAt": "Gültig bis",
  "settings.openrouter.catalog.title": "OpenRouter-Modellkatalog",
  "settings.openrouter.catalog.description": "Funktionen, Kontextlänge und Anbieterpreise.",
  "settings.openrouter.catalog.empty": "Es ist noch kein Modellkatalog zwischengespeichert. Aktualisieren Sie die Modelle, um ihn zu laden.",
  "settings.openrouter.capability.tools": "Werkzeuge",
  "settings.openrouter.capability.reasoning": "Schlussfolgerung",
  "settings.openrouter.capability.structured": "Strukturierte Ausgabe",
  "settings.openrouter.pricing": "Eingabe {{prompt}} · Ausgabe {{completion}} je Token",
  "settings.openrouter.secretNotice": "Zugangsdaten werden mit Windows-Schutz gespeichert und danach nicht mehr angezeigt.",
  "settings.openrouter.responseMissing": "OpenRouter hat eine unvollständige Antwort geliefert.",
  "settings.openrouter.state.unconfigured": "Nicht eingerichtet",
  "settings.openrouter.state.verifying": "Wird geprüft",
  "settings.openrouter.state.connected": "Verbunden",
  "settings.openrouter.state.attention": "Aktion erforderlich",
  "settings.openrouter.state.disconnected": "Getrennt",
