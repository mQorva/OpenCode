...
export const dict = {
  ...
  "desktop.menu.reloadWebview": "重新加载网页视图",
  "desktop.menu.restart": "重新启动",
  "desktop.menu.exportLogs": "导出日志...",
  "desktop.menu.newSession": "新建会话",
  "desktop.menu.newWindow": "新建窗口",
  "desktop.menu.closeWindow": "关闭窗口",
  "desktop.menu.addProject": "添加项目",
  "desktop.menu.undo": "撤消",
  "desktop.menu.redo": "恢复",
  "desktop.menu.cut": "剪切",
  ...
  "desktop.menu.shareFeedback": "发送反馈",
