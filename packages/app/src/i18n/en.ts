...
export const dict = {
  ...
  "home.tasks.project": "Project",
  "home.tasks.viewSessions": "View sessions",
  "home.tasks.create.title": "Create task",
  "home.tasks.create.action": "New task",
  "home.tasks.edit.title": "Edit task",
  "home.tasks.fields.title": "Title",
  "home.tasks.fields.title.placeholder": "What needs to be done?",
  "home.tasks.fields.description": "Description",
  "home.tasks.fields.description.placeholder": "Add context for this task",
  "home.tasks.active": "Current tasks",
  "home.tasks.archived": "Archived tasks",
  "home.tasks.showArchived": "Show archived",
  "home.tasks.hideArchived": "Hide archived",
  "home.tasks.restore": "Restore",
  "home.tasks.reopen": "Reopen",
  "home.tasks.workspace": "Workspace",
  "home.tasks.workspaceUnavailable": "No linked task session is available.",
  "home.tasks.startFailed": "The task workspace could not be started",
  "home.tasks.empty": "No tasks yet",
  "home.tasks.empty.description": "Create a task to keep the work for this project organized.",
  "home.tasks.error": "Tasks could not be loaded",
  "home.tasks.retry": "Try again",
  "home.tasks.status.ready": "Ready",
  "home.tasks.status.active": "Active",
  "home.tasks.status.waiting": "Waiting",
  "home.tasks.status.review": "Review",
  "home.tasks.status.completed": "Completed",
  "home.tasks.status.cancelled": "Cancelled",
  ...
  "settings.openrouter.title": "OpenRouter account",
  "settings.openrouter.manage": "Manage",
  "settings.openrouter.connect.title": "Connect OpenRouter",
  "settings.openrouter.connect.description": "Sign in in your browser or add an OpenRouter API key.",
  "settings.openrouter.connected": "OpenRouter is connected",
  "settings.openrouter.disconnected": "OpenRouter was disconnected",
  "settings.openrouter.verified": "OpenRouter access was verified",
  "settings.openrouter.modelsUpdated": "OpenRouter models were updated",
  "settings.openrouter.pkce.start": "Connect with OpenRouter",
  "settings.openrouter.pkce.waiting": "Waiting for OpenRouter…",
  "settings.openrouter.pkce.failed": "OpenRouter sign-in could not be completed.",
  "settings.openrouter.pkce.cancelled": "OpenRouter sign-in was cancelled.",
  "settings.openrouter.pkce.expired": "OpenRouter sign-in expired.",
  "settings.openrouter.key": "API key",
  "settings.openrouter.label": "Name (optional)",
  "settings.openrouter.key.connect": "Connect API key",
  "settings.openrouter.key.replace": "Replace API key",
  "settings.openrouter.key.new": "New API key",
  "settings.openrouter.account": "Account",
  "settings.openrouter.status": "Status",
  "settings.openrouter.usage": "Usage",
  "settings.openrouter.models": "Available models",
  "settings.openrouter.verify": "Verify access",
  "settings.openrouter.models.refresh": "Update models",
  "settings.openrouter.models.select": "Select models",
  "settings.openrouter.limitRemaining": "Remaining limit",
  "settings.openrouter.verifiedAt": "Last verified",
  "settings.openrouter.expiresAt": "Expires",
  "settings.openrouter.catalog.title": "OpenRouter model catalog",
  "settings.openrouter.catalog.description": "Capabilities, context length, and provider pricing.",
  "settings.openrouter.catalog.empty": "No cached model catalog is available yet. Update models to load it.",
  "settings.openrouter.capability.tools": "Tools",
  "settings.openrouter.capability.reasoning": "Reasoning",
  "settings.openrouter.capability.structured": "Structured output",
  "settings.openrouter.pricing": "Input {{prompt}} · Output {{completion}} per token",
  "settings.openrouter.secretNotice": "Secrets are stored with Windows protection and are never shown again.",
  "settings.openrouter.responseMissing": "OpenRouter returned an incomplete response.",
  "settings.openrouter.state.unconfigured": "Not configured",
  "settings.openrouter.state.verifying": "Verifying",
  "settings.openrouter.state.connected": "Connected",
  "settings.openrouter.state.attention": "Needs attention",
  "settings.openrouter.state.disconnected": "Disconnected",
