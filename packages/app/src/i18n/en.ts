...
export const dict = {
  ...
  "settings.permissions.saved.empty": "No project permissions have been saved.",
  "settings.permissions.saved.remove": "Remove",
  "settings.permissions.saved.close": "Close",
  ...
  "session.error.notFound.description": "This entry points to a session that no longer exists on this server.",
  "session.error.notFound.closeTab": "Remove entry",
  ...
  "settings.general.row.followup.description": "Choose the default behavior for follow-up prompts. Enter follows it; Ctrl+Enter does the opposite (sends immediately or queues).",
  ...
  "sidebarLayout.newChat": "New session",
  "sidebarLayout.pinned": "Pinned",
  "sidebarLayout.chats": "Sessions",
  ...
  "sidebarLayout.project": "Project",
  "sidebarLayout.projectStart.title": "Add project",
  "sidebarLayout.projectStart.description": "Choose how you want to start with this project.",
  "sidebarLayout.projectStart.folder": "Choose folder",
  "sidebarLayout.projectStart.folderDescription":
    "Open an existing project or an empty folder in the OpenCode picker.",
  "sidebarLayout.projectStart.server": "Connect server",
  "sidebarLayout.projectStart.serverDescription": "Open a project from an existing or new OpenCode server.",
  "sidebarLayout.projectStart.recent": "Recently closed",
  "sidebarLayout.rename": "Rename",
  "sidebarLayout.markUnread": "Mark unread",
  "sidebarLayout.unread": "Unread",
  "sidebarLayout.copyTitle": "Copy chat name",
  "sidebarLayout.copyID": "Copy chat ID",
  "sidebarLayout.copyProject": "Copy project name",
  "sidebarLayout.copied": "Copied to clipboard",
  "sidebarLayout.workspace": "Workspace",
  "sidebarLayout.workspace.toggle": "Toggle workspace",
  "sidebarLayout.workspace.terminal": "Terminal",
  "sidebarLayout.workspace.files": "Files",
  ...
  "session.delete.titleMultiple": "Delete multiple sessions",
  "session.delete.confirmMultiple": "Permanently delete these {{count}} sessions?",
  "session.delete.buttonMultiple": "Delete {{count}} sessions",
