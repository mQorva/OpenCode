...
const icons = {
  ...
  "stop": {
    viewBox: "0 0 16 16",
    body: `<rect x="4" y="4" width="8" height="8" rx="1" fill="currentColor"/>`,
  },
  "arrow-up": {
    viewBox: "0 0 16 16",
    body: `<path d="M8 13.5V3M8 3L3.5 7.5M8 3L12.5 7.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>`,
  },
  "arrow-undo-down": {
    viewBox: "0 0 16 16",
    body: `<path d="M3 8.5L1 6.5M1 6.5L3 4.5M1 6.5H11.5V12.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" fill="none"/>`,
  },
  shield: {
    viewBox: "0 0 16 16",
    body: `<path d="M8 1.75L13.25 3.75V7.75C13.25 10.75 11.05 13.25 8 14.25C4.95 13.25 2.75 10.75 2.75 7.75V3.75L8 1.75Z" stroke="currentColor" stroke-linejoin="round" fill="none"/>`,
  },
  "shield-question": {
    viewBox: "0 0 16 16",
    body: `<path d="M8 1.75L13.25 3.75V7.75C13.25 10.75 11.05 13.25 8 14.25C4.95 13.25 2.75 10.75 2.75 7.75V3.75L8 1.75Z" stroke="currentColor" stroke-linejoin="round" fill="none"/><path d="M6.75 6.25C6.75 5.56 7.31 5 8 5C8.69 5 9.25 5.56 9.25 6.25C9.25 7.25 8 7.25 8 8.5M8 10.5V10.75" stroke="currentColor" stroke-linecap="round" fill="none"/>`,
  },
  "shield-off": {
    viewBox: "0 0 16 16",
    body: `<path d="M8 1.75L13.25 3.75V7.75C13.25 10.75 11.05 13.25 8 14.25C4.95 13.25 2.75 10.75 2.75 7.75V3.75L8 1.75Z" stroke="currentColor" stroke-linejoin="round" fill="none"/><path d="M2.5 2.25L13.5 13.75" stroke="currentColor" stroke-linecap="round"/>`,
  },
  archive: {
    viewBox: "0 0 16 16",
