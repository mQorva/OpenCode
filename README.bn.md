...
## mQorva Edition – সাইডবার

> এই রিপোজিটরি [anomalyco/opencode](https://github.com/anomalyco/opencode)-এর একটি ফর্ক। এটি OpenCode দল তৈরি করেনি এবং তাদের সঙ্গে এর কোনো সম্পর্ক নেই। এই অংশের নিচে যা আছে তা মূল README।

![mQorva Edition-এর সাইডবার](docs/mqorva-sidebar.png)

মূল সংস্করণের তুলনায় দৃশ্যমান পার্থক্য হলো বাঁ পাশের সাইডবার। মূল সংস্করণে খোলা সেশনগুলো টাইটেল বারে ট্যাব হিসেবে থাকে; এখানে সেগুলো স্থায়ীভাবে বাঁ পাশের তালিকায় থাকে, প্রকল্প অনুযায়ী দলবদ্ধ।

**সাইডবার যা আলাদাভাবে করে**

- সেশনগুলো প্রকল্প অনুযায়ী দলবদ্ধ। উপরে থাকে «Pinned» ও «Sessions» ব্লক — শেষেরটিতে সেই সব এন্ট্রি থাকে যেগুলো কোনো খোলা প্রকল্পের অন্তর্গত নয়।
- ড্র্যাগ অ্যান্ড ড্রপ বরাদ্দ করে: কোনো সেশন প্রকল্পের উপর ছাড়লে সেটি সেই প্রকল্পে যুক্ত হয়, «Pinned»-এ ছাড়লে পিন হয়, আর ব্লকের ভেতরে সরালে ক্রম বদলায়।
- অনুসন্ধান সব ব্লকে চলে, খালি দলগুলো লুকায় এবং কিছু না মিললে তা জানায়।
- ডান ক্লিকে প্রকল্প ও সেশনের কনটেক্সট মেনু খোলে; তিন-বিন্দুর বোতাম নেই।
- প্রকল্প সেটিংসের রং ও আইকন তালিকায় দেখা যায়।
- প্রস্থ টেনে বদলানো যায় এবং তা সংরক্ষিত থাকে। কোনো প্রকল্প খোলা না থাকলেও টগলটি টাইটেল বারে পাওয়া যায়।
- সেশনের সারিতে সময় লেখা থাকে না; লম্বা শিরোনাম কার্সর রাখলে একবার সরে যায়।
- নতুন সেশন কোনো প্রকল্প ছাড়াই শুরু হয়। প্রকল্প কেবল তালিকাই নির্ধারণ করে — লেখার ঘরে দ্বিতীয় কোনো প্রকল্প নির্বাচক নেই।

**বদল**: Settings → General → «Sidebar layout»। বন্ধ করলে মূল সংস্করণের ট্যাব লেআউট ফিরে আসে।

সার্ভার, সেশন, প্রকল্প, ফাইল, টার্মিনাল ও সেটিংস অপরিবর্তিত OpenCode বৈশিষ্ট্যই থাকে; সাইডবার কেবল সেগুলো ভিন্নভাবে দেখায়। এই সংস্করণের বাকি পার্থক্য — নিজস্ব অ্যাপ আইডি, আলাদা ডেটা ডিরেক্টরি ও নিজস্ব সংস্করণ স্কিম — [MQORVA.md](MQORVA.md)-এ এবং পরিবর্তনের তালিকা [CHANGELOG.mqorva.md](CHANGELOG.mqorva.md)-এ নথিভুক্ত।

<sub>স্ক্রিনশটে জার্মান ইন্টারফেস; প্রকল্পের নাম বদলে দেওয়া হয়েছে।</sub>
